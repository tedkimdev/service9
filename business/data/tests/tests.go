...
import (
	...
	"github.com/tedkimdev/service9/business/data/schema"
	...
	"github.com/tedkimdev/service9/foundation/docker"
...
func NewUnit(t *testing.T, dbc DBContainer) (*zap.SugaredLogger, *sqlx.DB, func()) {
	...
	// teardown is the function that should be invokied when the caller is done
	// with the database.
	teardown := func() {
		t.Helper()
		db.Close()
