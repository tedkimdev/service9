// Package docker provides support for starting and stopping docekr containers
// for running tests.
package docker
...
// Container tracks information about the docekr container started for tests.
type Container struct {
	ID   string
	Host string // IP:Port
}

// StartContainer starts the specified contaienr for running tests.
